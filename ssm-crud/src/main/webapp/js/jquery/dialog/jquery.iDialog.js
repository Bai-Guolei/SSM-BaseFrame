...
~function($, window, undefined) {
    ...
    dialog.fn = dialog.prototype = {
        init: function(options) {
            ...
            this.width      = isMobile ? "100%" : options.width || 'auto';
            this.height     = isMobile ? "100%" : options.height || 'auto';
            ...
            this.opacity    = options.opacity === undefined ? 0 : options.opacity;
            ...
            this.effect     = isMobile ? options.effect === '' : (options.effect === undefined ? 'i-scale' : options.effect);
        ...
        //  this.width = this.$dialog.width();  这个方法赋值重复了
        //  this.height = this.$dialog.height(); 这个方法赋值重复了
