...
td.find("span:first")[0].innerHTML=col.title;
...
cell[0].innerHTML="<table border=\"0\" cellspacing=\"0\" cellpadding=\"1\"><tr><td></td></tr></table>";
...
$(_20d)[0].innerHTML=this.renderTable(_20c,0,rows,_20e);
...
tr[0].innerHTML=this.renderRow.call(this,_229,_231,_230,_22a,_22b);
...
tr.find("div.datagrid-cell-rownumber")[0].innerHTML=_23a;
}
if(opts.striped){
...
cc[0].innerHTML="<table class=\"datagrid-btable\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody>"+tr+"</tbody></table>";
}
}else{
...
tr.find("div.datagrid-cell-rownumber")[0].innerHTML=_246;
}
if(opts.striped){
tr.removeClass("datagrid-row-alt").addClass((i-1)%2?"datagrid-row-alt":"");
}
...
_250[0].innerHTML=this.renderTable(_24e,0,[{}],false);
