<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
	<c:set value="${pageContext.request.contextPath}" var="ROOT" scope="page"/>
	<%-- CSS --%>
<%-- 	<link rel="stylesheet" href="${ROOT}/js/font-awesome/font-awesome.min.css"/> --%>
	...
	<script type="text/javascript" src="${ROOT}/js/jquery/easyui/jquery.easyui.patch.js"></script>
	...
	<%-- jQuery Confirm --%>
	<!--[if IE 9]>
    <script src="${ROOT}/js/base64.min.js"></script>
    <![endif]-->
